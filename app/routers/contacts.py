...
def contacts_normal(  request: Request,
                      ...
                      skills_state_string: Optional[str] = "PHP-skill.Javascript-skill.Python-skill.Laravel-skill.Wordpress-skill.Bootstrap-skill.Other-skill",
                      category_string: Optional[str] = "None",
                      category_state_string: Optional[str] = "DevelopmentandIT-category.AIServices-category.DesignandCreative-category.SalesandMarketing-category.FinanceandAccounting-category.EngineeringandArchitecture-category.Other-category",
